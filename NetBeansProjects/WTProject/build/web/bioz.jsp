<%-- 
    Document   : bio
    Created on : 6 Oct, 2014, 12:04:17 AM
    Author     : Siddhant
--%>
		...
		<div class="content login-box">
			...
			<!---//caption-script---->
							...
							<div class="product-pic">
								<a><img src="images/product21.jpg" style="width:250px;height:380px" /></a>
								<p>
								<a href="#"><small>Angela's Ashes</a>							
								<span>Frank McCourt</span></br>
								RS.375
						...
						<div  class="product-grid fade">
							...
							<div class="product-pic">
								<a ><img src="images/product22.jpg" style="width:250px;height:380px" /></a>
								<p>
								<a ><small>Audacity of Hope</a>							
								<span>Barack Obama</span></br>
								RS.541
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product23.gif" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Einstein</a>							
								<span>Walter Issacson</span></br>
								RS.680
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product24.jpg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>The Story of my Life</a>							
								<span>Helen Keller</span></br>
								RS.421
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product25.jpg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Steve Jobs</a>							
								<span>Walter Issacson</span></br>
								RS.600
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product26.png" style="width:250px;height:380px" /></a>
								<p>
								<a><small>The Diary of a young girl</a>							
								<span>Anne Frank</span></br>
								RS.645
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
