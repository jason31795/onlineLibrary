<%-- 
    Document   : med
    Created on : 6 Oct, 2014, 12:09:08 AM
    Author     : Siddhant
--%>
		...
		<div class="content login-box">
			...
			<!---//caption-script---->
							...
							<div class="product-pic">
								<a><img src="images/product61.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a ><small>Controversies in Neurosurgery</a>							
								<span>Thieme Medical </span></br>
								RS.641
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a ><img src="images/product62.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a ><small>Financial Management</a>							
								<span>I. M. Pandey</span></br>
								RS.872
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product63.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Human Resource Management</a>							
								<span>K. Aswathappa</span></br>
								RS.1340
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a ><img src="images/product64.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Principles Of Marketing</a>							
								<span>Philip Kotler, Prafulla Y </span></br>
								RS.978
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product65.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Reactions, Rearrangements and Reagents</a>							
								<span>Sanyal S N</span></br>
								RS.864
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div  class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product66.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Microbiology</a>							
								<span>Ananthanarayan, Paniker</span></br>
								RS.1244
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
