<%-- 
    Document   : eng
    Created on : 6 Oct, 2014, 12:06:56 AM
    Author     : Siddhant
--%>
		...
		<div class="content login-box">
			...
			<!---//caption-script---->
							...
							<div class="product-pic">
								<a><img src="images/product51.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a ><small>Concepts of Physics</a>							
								<span>H C Verma</span></br>
								RS.521
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a ><img src="images/product52.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a ><small>Data Structure using C</a>							
								<span>Seymour Lipschutz</span></br>
								RS.972
								<a href="buy.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product53.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Engineering Mathematics</a>							
								<span>Rukmangadachari</span></br>
								RS.1120
								<a href="buy.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a ><img src="images/product54.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Engineering Mechanics</a>							
								<span>S S Bhavikatti</span></br>
								RS.857
								<a href="buy.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product55.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Organic Chemistry</a>							
								<span>Craig B</span></br>
								RS.854
								<a href="buy.jsp" target="_blank">BUY</a>
								</p>
						...
						<div  class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product56.jpeg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Programming in C</a>							
								<span>Balagurusamy</span></br>
								RS.477
								<a href="buy.jsp" target="_blank">BUY</a>
								</p>
