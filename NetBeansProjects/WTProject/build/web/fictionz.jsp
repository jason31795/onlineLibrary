<%-- 
    Document   : fiction
    Created on : 6 Oct, 2014, 12:07:24 AM
    Author     : Siddhant
--%>
		...
		<div class="content login-box">
			...
			<!---//caption-script---->
							...
							<div class="product-pic">
								<a><img src="images/product1.jpg" style="width:250px;height:380px" /></a>
								<p>
								<a ><small>The Kite Runner</a>							
								<span>Khaled Hosseini</span></br>
								RS.450
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a ><img src="images/product2.jpg" style="width:250px;height:380px" /></a>
								<p>
								<a ><small>A Song of Ice and Fire</a>							
								<span>George R.R. Martin</span></br>
								RS.4500
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product3.jpg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Enders Game</a>							
								<span>Orson Scott Card</span></br>
								RS.390
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a ><img src="images/product4.jpg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>The Great Gatsby</a>							
								<span>Francis Scott Fitzgerald</span></br>
								RS.600
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product5.gif" style="width:250px;height:380px" /></a>
								<p>
								<a><small>Wuthering Heights</a>							
								<span>Emile Bronte</span></br>
								RS.600
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
						...
						<div  class="product-grid fade">
							...
							<div class="product-pic">
								<a><img src="images/product6.jpg" style="width:250px;height:380px" /></a>
								<p>
								<a><small>To Kill a Mocking Bird</a>							
								<span>Harper Lee</span></br>
								RS.800
								<a href="buyz.jsp" target="_blank">BUY</a>
								</p>
