<%-- 
    Document   : near
    Created on : 6 Oct, 2014, 12:10:02 AM
    Author     : Siddhant
--%>
	...
	<body>
		...
		<div class="content login-box">
			<div class="login-main">
				...
				<p1>	The Book Store went live in 2010 with the objective of making books easily available to anyone who had internet access. Today, we're present across various categories!
		...
		So it's no surprise that we're a favourite online shopping destination.</br></br>

				</p1>	</br>
					<p1>The Book Store Private Limited,</p1></br>	
					<p1>Kale Rhodes Park,</p1></br>
					<p1>St. John Baptist Road,</p1></br>
					<p1>Bandra West, Mumbai - 400050</p1></br>
					<p1>Phone No:. 9539692950, 022-24214364, 022-22424343</p1></br>	
					<p1>Email:. feedback@thebookstore.com</p1></br>
				</div>
			</div>		
		</div>
